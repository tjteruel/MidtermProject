...
CREATE TABLE IF NOT EXISTS `event` (
  ...
  `status` ENUM('Delayed', 'Canceled', 'Scheduled') CHARACTER SET 'utf8' NOT NULL DEFAULT 'Scheduled',
...
START TRANSACTION;
USE `quarantinedb`;
INSERT INTO `category_comment` (`id`, `user_id`, `category_id`, `content`, `create_date`) VALUES (1, 1, 1, 'Love watching all the animals live! You definitely have to do your research to  determine when the animals are the most active!', '2020-01-01 10:10:10');
INSERT INTO `category_comment` (`id`, `user_id`, `category_id`, `content`, `create_date`) VALUES (2, 2, 2, 'Surprised that there is such awesome music that you can watch live!', '2020-01-01 10:10:10');
INSERT INTO `category_comment` (`id`, `user_id`, `category_id`, `content`, `create_date`) VALUES (3, 3, 3, 'I am finally able to see art that I never had time to visit in person.', '2020-01-01 10:10:10');
INSERT INTO `category_comment` (`id`, `user_id`, `category_id`, `content`, `create_date`) VALUES (4, 4, 4, 'Excited to virtually visit museums that I otherwise would never see because of the distance.', '2020-01-01 10:10:10');
INSERT INTO `category_comment` (`id`, `user_id`, `category_id`, `content`, `create_date`) VALUES (5, 5, 5, 'The speaking events have not let me down so far, great experts and opinions', '2020-01-01 10:10:10');
...
START TRANSACTION;
USE `quarantinedb`;
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (1, 'San Diego Zoo', 'events@sandiegozoo.org ', 1, '6192311515', 'https://zoo.sandiegozoo.org/', 'https://sdchamber.org/wp-content/uploads/2016/07/san-diego-zoo-logo.jpg');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (2, 'Smithsonian\'s National Zoo', 'events@nationalzoo.edu', 2, '2026334888', 'https://nationalzoo.si.edu/', 'https://www.si.edu/sites/default/files/newsdesk/press_releases/si_large_color.jpg');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (3, 'Motus Theater', 'INFO@MOTUSTHEATER.ORG', 3, '7204322004', 'https://www.motustheater.org/', 'https://images.squarespace-cdn.com/content/v1/5ae20263aa49a1f4000bf576/1555966157999-G4AWQ4RHAFC7FCV2O9PW/ke17ZwdGBToddI8pDm48kFyJMLJlQZGARyeR1BU4y5MUqsxRUqqbr1mOJYKfIPR7LoDQ9mXPOjoJoqy81S2I8N_N4V1vUb5AoIIIbLZhVYy7Mythp_T-mtop-vrsUOmeInPi9iDjx9w8K4ZfjXt2dqTir2K1URVvEFX2lMZ1XBYtGOrZnVHUd6ZgSMiKBaOXCjLISwBs8eEdxAxTptZAUg/Motus-WhiteVariant2.png');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (4, 'Aspen Words', 'aspenwords@aspeninstitute.org', 4, '9709253122', 'http://www.aspenwords.org/', 'http://www.aspenwords.org/wp-content/themes/aspen-writers/images/logo-interior.png');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (5, 'Denver Public Art', 'public.art@denvergov.org', 5, '7208655563', '\nhttp://www.denverpublicart.org', 'https://denverpublicart.org/wp-content/themes/denver/dist/images/new-denver-logo.png');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (6, 'Denver Art Museum', 'pressoffice@denverartmuseum.org', 6, '7208655000', 'https://denverartmuseum.org/', 'https://res.cloudinary.com/micronetonline/image/upload/c_crop,h_203,w_450,x_0,y_0/v1553804603/tenants/6b8a1089-4977-4a15-ac7f-97edaddc067a/9011001840c64dcca5b0b3677b2e68f0/Art.png');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (7, 'Denver Botanic Gardens', 'administration@botanicgardens.org', 7, '7208653500', 'https://www.botanicgardens.org/', 'https://www.castlepinesconnection.com/wp-content/uploads/2020/01/DenverBotanicGarden.jpg');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (8, 'Denver Zoo', 'guestcare@denverzoo.org', 8, '7203371400', 'https://www.denverzoo.org/', 'https://www.denverzoo.org/wp-content/uploads/2018/07/logo.png');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (9, 'Walker Fine Art', 'lgaron@walkerfineart.com', 9, '3033558955', 'http://www.walkerfineart.com/', 'http://www.walkerfineart.com/inner-voyages-virtual-tour');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (10, 'London Symophony Orchestra', 'admin@lso.co.uk', 10, '442075881116', 'https://lso.co.uk/', 'https://i.pinimg.com/originals/0b/16/f4/0b16f414c80e759a6beedecc5d1298b8.jpg');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (11, 'Berliner Philharmoniker', 'kartenbuero@berliner-philharmoniker.de', 11, '4930254880', 'https://www.berliner-philharmoniker.de/en/', 'https://www.berliner-philharmoniker.de/app/assets/images/main-header/brand.svg');
INSERT INTO `host` (`id`, `host_name`, `email`, `location_id`, `phone_number`, `url`, `url_logo`) VALUES (12, 'Gothenburg Symphony Orchestra', 'biljett@gso.se', 12, '317265300', 'https://www.gso.se/en/', 'https://www.gso.se/wp-content/themes/gso/assets/images/gso-top-logo.png');
...
START TRANSACTION;
USE `quarantinedb`;
INSERT INTO `event_comment` (`id`, `user_id`, `event_id`, `content`, `create_date`) VALUES (1, 6, 4, 'Is there any live streams happening leading up to the awards ceremony?', '2020-01-01 10:10:10');
INSERT INTO `event_comment` (`id`, `user_id`, `event_id`, `content`, `create_date`) VALUES (2, 7, 1, 'How can I donate to the help the cute penguins?', '2020-01-01 10:10:10');
...
START TRANSACTION;
USE `quarantinedb`;
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (1, 1, 'animals', '2020-01-01 10:10:10');
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (2, 2, 'music', '2020-01-01 10:10:10');
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (3, 3, 'art', '2020-01-01 10:10:10');
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (4, 4, 'tour', '2020-01-01 10:10:10');
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (5, 5, 'museum', '2020-01-01 10:10:10');
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (6, 6, 'literature', '2020-01-01 10:10:10');
INSERT INTO `tag` (`id`, `user_id`, `tag_name`, `create_date`) VALUES (7, 7, 'women', '2020-01-01 10:10:10');
...
START TRANSACTION;
USE `quarantinedb`;
INSERT INTO `user_event` (`user_id`, `event_id`, `attended`, `rating`, `rating_comment`) VALUES (1, 1, 1, 4, 'Great Event!!');
